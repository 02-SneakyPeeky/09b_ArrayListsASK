...
public class App {
	...
	public static void main(String[] args) {
		...
		// // Iteration 1
		for (int i = 0; i < carMakers.size(); i++) {   // gleiche ausgabe wie Iteration 2, jedoch kann man hier auch 
			System.out.print(carMakers.get(i) + " ");  // einzelne einträge anzeigen lassen 
		}
